									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="fullname" name="fullname"
												...
												value="<?= @$fetchusers['fullname'] ?>" />
										</div>
										<label for="clientContact" class="col-sm-2 control-label">Username</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" pattern="^[a-zA-Z0-9]*$"
												id="check_userName" name="username" placeholder="Username"
												autocomplete="off" required value="<?= @$fetchusers['username'] ?>" />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="password" name="password"
												placeholder="Password" autocomplete="off" /><span style="color: red"
												class="text-center">Password Automatically encrypted due to security
												issues</span>
											<input type="hidden" name="old_password"
												value="<?= isset($_REQUEST['user_edit_id']) ? $fetchusers['password'] : '' ?>" />
										</div>
										...
										<div class="col-sm-4">
											<select class="form-control" name="status">
												<option <?= @($fetchusers['status'] == "1") ? "seleted" : "" ?> value="1">
													Active</option>
												<option <?= @($fetchusers['status'] == "0") ? "seleted" : "" ?> value="0">
													Not Active</option>
											</select>
										</div>
									</div> <!--/form-group-->
													...
													<td>
														...
														if ($row['status'] == '1') {
															...
															<span class="label label-lg label-info"
																style="font-size: ">Available</span>
															<?php
															# code...
														} else {
															?>
															<span class="label label-lg label-danger" style="font-size: "> Not
																Available</span>
															<?php
														}
														?>

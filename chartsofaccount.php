...
<div class="col-sm-6">
	...
	<div class="panel-heading" align="center"><h4>Create Charts Of Account</h4></div>
	...
	if ( mysqli_num_rows($result) > 0) {
		while($row = mysqli_fetch_array($result)){
			...
			<tr>
				...
				<td><a href="chartsofaccount.php?budget_category_del_id=<?=$row['budget_category_id']?>" class="text-danger"><span class="glyphicon glyphicon-remove"></span></a> | 
					<a href="chartsofaccount.php?budget_category_edit_id=<?=$row['budget_category_id']?>" class="text-success"><span class="glyphicon glyphicon-edit"></span></a></td>

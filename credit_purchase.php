      ...
      <div class="card">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-2">
            ...
            <select name="purchase_type" onchange="purchaseType(this.value); updatePurchaseId(this.value)"
          ...
          <div class="col-sm-3">
            ...
            <div class="input-group">
              <select class="form-control searchableSelect supplier_name" name="cash_purchase_supplier" id="credit_order_client_name"
                required onchange="getBalance(this.value,'customer_account_exp')" aria-label="Username"
          ...
          <div class="col-sm-2">
            ...
            <input type="file" autocomplete="off" value="<?= @$fetchPurchase['purchase_file'] ?>" class="form-control"
              name="purchase_file">
          </div>
        ...
        <div class="form-group row mb-3">
          ...
          <div class="col-1 col-md-1">
            ...
            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#add_product_modal"> <i
                ...
                <tr>
                  ...
                  <td class="table-bordered">
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <input type="number" step="0.001" min="0" class="form-control form-control-sm" id="paid_ammount"
                          required onkeyup="getRemaingAmount()" name="paid_ammount"

...
");
                ...
                <input type="text" name="next_increment" id="next_increment" value="SF25-PR-<?= @empty($_REQUEST['edit_purchase_id']) ? $next_increment : $fetchPurchase['purchase_id'] ?>" readonly class="form-control">
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-2">
                ...
                <select name="purchase_type" onchange="purchaseType(this.value)" class="form-control" id="purchase_type">
                  ...
                  <option <?= isset($_REQUEST['edit_purchase_id']) ? "" : "selected" ?> value="credit" <?= @$fetchPurchase['payment_type'] == "credit" ? "selected" : "" ?>>Credit</option>
                </select>

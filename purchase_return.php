        ...
        <div class="card-header card-bg" align="center">
          ...
          <div class="row">
            <div class="col-12 mx-auto h4">
              <b class="text-center card-text">Purchase Return</b>
              ...
              <div class="col-md-3">
                <div class="row">
                  <div class="col-5 pr-1">
                    <label>ID#</label>
                    <?php
                    $result = mysqli_query($dbc, "SHOW TABLE STATUS LIKE 'purchase_return'");
                    $data = mysqli_fetch_assoc($result);
                    $next_increment = $data['Auto_increment'];
                    ?>
                    <input type="text" name="next_increment" id="next_increment"
                      value="SF25-PR-<?= @empty($_REQUEST['edit_purchase_id']) ? $next_increment : $fetchPurchase['purchase_id'] ?>"
            ...
            <div class="form-group row mb-3">
              ...
              <div class="col-1 col-md-1">
                ...
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                  data-target="#add_product_modal" onclick="openAddProductModal()"> <i class="fa fa-plus"></i> </button>
              </div>
                ...
                <table class="table  saleTable" id="myDiv">
                  ...
                  <tbody class="table table-bordered" id="purchase_product_tb">
                    <?php if (isset($_REQUEST['edit_purchase_id'])):
                      $q = mysqli_query($dbc, "SELECT  product.*,categories.*,brands.*,purchase_return_item.* FROM purchase_return_item LEFT JOIN product ON product.product_id=purchase_return_item.product_id LEFT JOIN categories ON product.category_id=categories.categories_id LEFT JOIN brands ON product.brand_id=brands.brand_id   WHERE purchase_return_item.purchase_id='" . base64_decode($_REQUEST['edit_purchase_id']) . "'");

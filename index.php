      ...
      <div class="col-lg-4 col-md-5 col-10 mx-auto text-center bg-white  shadow  rounded">
        ...
        <form action="index.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="email" id="inputEmail" class="form-control form-control-lg" placeholder="Email Here..." required="" name="username" autofocus="">
          </div>
          <div class="form-group">
          ...
          <button class="btn btn-lg btn-admin btn-block" type="submit" name="login">Signin</button>

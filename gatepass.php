                    ...
                    <form action="php_action/custom_action.php" method="POST" id="sale_order_fm">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                <select class="form-control searchableSelect" name="from_branch" id="branch_id" required>
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" autocomplete="off" name="gatepass_narration"
                                    value="<?= htmlspecialchars(@$fetchGatepass['gatepass_narration']) ?>" class="form-control">
                            </div>
                            ...
                            <div class="col-sm-2">
                                <label>Attach File
                                    <?php if (!empty($fetchGatepass['gatepass_file'])): ?>
                                        <a href="img/uploads/<?= htmlspecialchars($fetchGatepass['gatepass_file']) ?>" target="_blank">
                                ...
                                <table class="table  saleTable" id="myDiv">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="table-bordered" id="product_total_amount"><?= @$fetchGatepass['total_amount'] ?></td>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-bordered" id="getDiscount"><input onkeyup="getOrderTotal()" type="number" id="ordered_discount" class="form-control form-control-sm" value="<?= @empty($_REQUEST['edit_order_id']) ? $fetchGatepass['discount'] : "0" ?>" min="0" name="ordered_discount">
                                            </td>
                                            <td class="table-bordered"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-bordered" id="product_grand_total_amount"><?= @$fetchGatepass['grand_total'] ?></td>
                                            </td>
                                            <td class="table-bordered"></td>

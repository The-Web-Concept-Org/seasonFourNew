...
");
                            ...
                            <div class="col-sm-2 cash-sale-div1">
                                ...
                                <input type="number" onchange="getCustomer_name(this.value)" value="" autocomplete="off"
                                    min="0" class="form-control" name="client_contact" list="phone">
                                <datalist id="phone">
                                    <?php
                            ...
                            <div class="col-sm-2 cash-sale-div2">
                                ...
                                <input type="text" id="sale_order_client_name" value="" class="form-control"
                        ...
                        <div class="form-group row mb-5">
                            ...
                            <div class="col-6 col-sm-1 col-md-1">
                                ...
                                <input type="number" min="0" class="form-control" id="get_final_rate">
                            </div>
                            <div class="col-6 col-sm-2 col-md-1">
